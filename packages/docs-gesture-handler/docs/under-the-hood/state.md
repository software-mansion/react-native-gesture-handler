...
| **`END`**          | The user successfully completed the gesture.                                             | [`onDeactivate`](/docs/fundamentals/callbacks-events#ondeactivate) <br/><br/> [`onFinalize`](/docs/fundamentals/callbacks-events#onfinalize)                                                                                      |
| **`FAILED`**       | The handler failed to recognize the gesture.                                             | [`onDeactivate`](/docs/fundamentals/callbacks-events#ondeactivate) if the gesture was in `ACTIVE` state before. <br/><br/> [`onFinalize`](/docs/fundamentals/callbacks-events#onfinalize)                                         |
| **`CANCELLED`**    | The system interrupted the gesture.                                                      | [`onDeactivate`](/docs/fundamentals/callbacks-events#ondeactivate) if the gesture was in `ACTIVE` state before. <br/><br/> [`onFinalize`](/docs/fundamentals/callbacks-events#onfinalize)                                         |
