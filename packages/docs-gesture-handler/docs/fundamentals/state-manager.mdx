...
If you want to control gesture lifecycle outside of it, you can use `handlerTag` from created gesture object. Note that gesture can only be activated after it has begun, that is, after it has received received touch events.
