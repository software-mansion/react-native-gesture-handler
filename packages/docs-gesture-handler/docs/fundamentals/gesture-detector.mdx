...
<HeaderWithBadges platforms={['web']}>### userSelect</HeaderWithBadges>
...
<HeaderWithBadges platforms={['web']}>### touchAction</HeaderWithBadges>
...
<HeaderWithBadges platforms={['web']}>### enableContextMenu</HeaderWithBadges>
