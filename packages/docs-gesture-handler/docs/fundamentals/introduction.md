...
- The ability to define [relations between gestures](/docs/composition/overview) to ensure gestures, and possibly native components, will not conflict with each other.
