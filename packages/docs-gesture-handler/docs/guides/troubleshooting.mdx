...
- In order for the [gesture composition](/docs/category/gesture-composition--interactions) to work, all composed gestures must be attached to the same [`GestureHandlerRootView`](/docs/fundamentals/root-view).
