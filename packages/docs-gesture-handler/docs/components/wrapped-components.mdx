...
Some components come with [`Native`](/docs/gestures/use-native-gesture) gesture pre-applied. This allows them to participate in gesture recognition process. Have a look at the example below.
