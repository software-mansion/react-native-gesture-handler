...
Distance that the panel must be dragged from the left to be considered a swipe. The default value is `10`.
...
Distance that the panel must be dragged from the right to be considered a swipe. The default value is `10`.
