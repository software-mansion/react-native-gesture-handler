...
The handler [activates](/docs/2.x/under-the-hood/state#active) when pressure of touch is greater or equal to `minForce`. It fails if pressure is greater than `maxForce`.
