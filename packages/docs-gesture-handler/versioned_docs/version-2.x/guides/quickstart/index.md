...
RNGH2 provides much simpler way to add gestures to your app. All you need to do is wrap the view that you want your gesture to work on with [`GestureDetector`](/docs/2.x/gestures/gesture-detector), define the gesture and pass it to detector. That's all!
