...
export interface GestureHandlerPlatformPort {
  ...
  worklets: WorkletsIntegration | undefined;
}

export type LastUpdateEventMap = Map<number, ReanimatedContext<unknown>>;

// Internal per-binding state threaded as the first argument through every
...
export interface CoreRuntime {
  ...
  // Lazily created once per binding (see createLastUpdateEventMap); the
  // binding's runtime module owns the memoization.
