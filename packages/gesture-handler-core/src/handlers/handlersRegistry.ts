...
// The legacy (v1/v2) gesture object type lives in the platform package; the
// registry only stores and returns these objects, so it is kept loose here.
// TODO(split): replace with a minimal structural interface before extraction ships.
// eslint-disable-next-line @typescript-eslint/no-explicit-any
type GestureType = any;
