...
export type GestureCallbacks<TBaseHandlerData, THandlerData> = {
  onBegin?: GestureEventCallback<TBaseHandlerData>;
  ...
  onFinalize?: GestureEventCallbackWithDidSucceed<TBaseHandlerData>;
