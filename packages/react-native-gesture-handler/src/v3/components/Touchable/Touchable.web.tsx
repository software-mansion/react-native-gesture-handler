...
export const Touchable = (props: TouchableProps) => {
  ...
  // The last event observed by the gesture, used as the payload of the
  // long-press callback since it fires from a timer rather than an event.
  const lastEvent = useRef<CallbackEventType | null>(null);
