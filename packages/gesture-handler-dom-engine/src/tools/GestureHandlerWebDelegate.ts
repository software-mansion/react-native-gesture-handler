  ...
  implements GestureHandlerDelegate<HTMLElement, IGestureHandler>
{
  ...
  // The platform binding may pass its own resolver to handle host-framework
  // refs the generic DOM walk knows nothing about (react-native-web FlatList).
  private readonly resolveViewRef: typeof findNodeHandle;

  constructor(resolveViewRef: typeof findNodeHandle = findNodeHandle) {
    this.resolveViewRef = resolveViewRef;
  }
  ...
  init(viewRef: number, handler: IGestureHandler): void {
    ...
    this.view =
      ...
      !isRNSVGElement(viewRef as unknown as SVGRef)
        ...
        : (this.resolveViewRef(viewRef) as unknown as HTMLElement);
