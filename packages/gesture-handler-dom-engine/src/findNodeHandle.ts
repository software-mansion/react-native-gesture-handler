...
// Generic DOM node resolution. Host-framework specials (e.g. react-native-web
// FlatList) are handled by the platform binding before delegating here — see
// react-native-gesture-handler's findNodeHandle.web.ts.
