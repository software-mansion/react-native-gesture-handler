GESTURE_HANDLER_COMMON_THIS_DIR := $(call my-dir)

include $(CLEAR_VARS)

LOCAL_PATH := $(GESTURE_HANDLER_COMMON_THIS_DIR)
LOCAL_MODULE := rngesturehandler_common
