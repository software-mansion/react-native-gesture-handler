...
class RNGestureHandlerRegistry : GestureHandlerRegistry {
  ...
  fun attachHandlerToView(handlerTag: Int, viewTag: Int): Boolean {
    return attachHandlerToViewWithReceiver(handlerTag, viewTag, viewTag)
  }

  @Synchronized
  fun attachHandlerToViewWithReceiver(handlerTag: Int, viewTag: Int, receiverTag: Int): Boolean {
