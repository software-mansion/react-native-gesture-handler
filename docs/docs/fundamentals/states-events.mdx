...
import ComposedGestureSrc from '!!raw-loader!@site/src/examples/ComposedGesture';
...
<InteractiveExample
  src={null}
  component={null}
  label="State flow chart"
  larger={true}
/>

<InteractiveExample
  src={ComposedGestureSrc}
  component={<ComposedGesture />}
  label="Drag or tap the circle"
/>

<CollapsibleCode showLines={[24, 53]} src={ComposedGestureSrc} />
